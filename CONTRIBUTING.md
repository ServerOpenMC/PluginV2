...
## 📖 Code de conduite
Merci de lire notre [Code de conduite](https://github.com/ServerOpenMC/PluginV2/blob/master/CODE_OF_CONDUCT.md) pour assurer un moment convivial à tous les contributeurs
