...
public class SeaCreatureLootTable extends CustomLootTable {
    ...
    public Set<CustomLoot> getLoots() {
        return Set.of(
                new SeaCreatureLoot(OMCRegistry.CUSTOM_MOBS.SEA_GUARD, 0.3),
                new SeaCreatureLoot(OMCRegistry.CUSTOM_MOBS.ANCIENT_VILLAGER, 0.1),
                new SeaCreatureLoot(OMCRegistry.CUSTOM_MOBS.CHICKEN_JOCKEY, 0.4),
                new SeaCreatureLoot(OMCRegistry.CUSTOM_MOBS.POISSON_STEVE, 0.2)
        );
    }
}