...
public class LegendaryFishingTreasureLootTable extends CustomLootTable {
    ...
    public Set<CustomLoot> getLoots() {
        return Set.of(
                new ItemLoot(OMCRegistry.CUSTOM_ITEMS.ANCIENT_FISHER_HELMET, OMCRegistry.CUSTOM_ITEMS.ANCIENT_FISHER_HELMET, 0.20, 1, 1),
                new ItemLoot(OMCRegistry.CUSTOM_ITEMS.ANCIENT_FISHER_BOOTS, OMCRegistry.CUSTOM_ITEMS.ANCIENT_FISHER_BOOTS, 0.20, 1, 1),
