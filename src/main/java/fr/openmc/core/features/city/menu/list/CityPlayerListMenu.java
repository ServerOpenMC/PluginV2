...
public class CityPlayerListMenu extends PaginatedMenu {
    ...
    public Map<Integer, ItemMenuBuilder> getButtons() {
        ...
        map.put(49, new ItemMenuBuilder(this, OMCRegistry.CUSTOM_ITEMS.ICON_CANCEL, itemMeta -> itemMeta.displayName(TranslationManager.translation("messages.menus.close"))).setCloseButton());
