...
public class CityRankIconMenu extends PaginatedMenu {
	...
	public CityRankIconMenu(Player owner, City city, int page, CityRank rank) {
		super(owner);
		this.rank = rank;
		this.city = city;
		this.page = page;
	...
	public int getSizeOfItems() {
		return paginableMaterials.size();
	}
	...
	public Map<Integer, ItemStack> getButtons() {
		...
		if (hasPreviousPage())
			map.put(48, new ItemBuilder(this, CustomStack.getInstance("_iainternal:icon_back_orange")
				...
				new CityRankIconMenu(getOwner(), city, page - 1, rank).open();
			}));
		if (hasNextPage())
