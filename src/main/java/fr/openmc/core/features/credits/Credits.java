...
public enum Credits {
    ...
    CONTEST(OMCRegistry.CUSTOM_ITEMS.CONTEST_SHELL, "feature.credits.feature.contest", ContestManager.class),
    ...
    Credits(CustomItem customItem, String featureKey, Set<String> developpers) {
        this.icon = customItem.getBest();
        this.developpers = developpers;
        this.featureKey = featureKey;
        this.graphists = Set.of();
    ...
    Credits(CustomItem customItem, String featureKey, Set<String> developpers, Set<String> graphists) {
        this.icon = customItem.getBest();
        this.featureKey = featureKey;
        this.developpers = developpers;
    ...
    Credits(CustomItem customItem, String featureKey, Set<String> developpers, Set<String> graphists, Set<String> builders) {
        this.icon = customItem.getBest();
        this.featureKey = featureKey;
        this.developpers = developpers;
        this.graphists = graphists;
