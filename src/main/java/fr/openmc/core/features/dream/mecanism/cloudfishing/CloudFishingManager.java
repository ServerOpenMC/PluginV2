...
public class CloudFishingManager {
    ...
    public static final CustomLootTable FISHING_LOOT_TABLE = OMCRegistry.CUSTOM_LOOT_TABLES.getOrThrow("omc_dream:cloud_fishing");
    ...
    public static void simulateDreamFishing(Player player, FishHook hook) {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                ParticleUtils.sendParticlePacket(player, Particle.WITCH, point.add(0, 1, 0), 3, 0.1, 0.1, 0.1, 0.01, null);

                ParticleUtils.spawnCloudParticles(player, Particle.CLOUD, point, 65, 5, 1.5);
