package fr.openmc.core.features.quests.menu;
...
import fr.openmc.core.features.quests.utils.QuestsUtils;
...
public class QuestsMenuTarget extends PaginatedMenu {
	...
	public Map<Integer, ItemStack> getButtons() {
		...
		ArrayList<ItemBuilder> navBtns = MenuUtils.getNavigationButtons(this);
