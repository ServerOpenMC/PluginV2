...
public class QuestsMenu extends Menu {
    ...
    public @NotNull Map<Integer, ItemBuilder> getContent() {
        ...
        if (this.currentPage > 0) {
            content.put(19, new ItemBuilder(this, OMCRegistry.CUSTOM_ITEMS.QUESTS_LEFT_ARROW, meta ->
                    meta.displayName(Component.text("Page précédente").decoration(TextDecoration.ITALIC, false))
            ));
        }

        if (this.currentPage < this.totalPages - 1) {
            content.put(25, new ItemBuilder(this, OMCRegistry.CUSTOM_ITEMS.QUESTS_RIGHT_ARROW, meta ->
